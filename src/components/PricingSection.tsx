...
import CheckoutButton from './CheckoutButton'; // Импортируем ваш компонент CheckoutButton
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <p className="text-4xl font-bold mb-6">$25<span className="text-xl text-gray-500 font-normal">/month</span></p>
          ...
          {/* Annual Plan */}
          <div className="bg-white rounded-lg shadow-md p-8 border-4 border-blue-500 relative">
            ...
            <p className="text-4xl font-bold mb-2">$240<span className="text-xl text-gray-500 font-normal">/year</span></p>
            <p className="text-green-600 font-semibold mb-6">Save 20% compared to monthly</p>
            <ul className="space-y-3 mb-8">
              <li className="flex items-center">
                <Check className="text-green-500 mr-2" />

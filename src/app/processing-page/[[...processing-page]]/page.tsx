...
useEffect(() => {
  console.log(priceIdFromLocal, isSignedIn, user?.id, user?.primaryEmailAddress?.emailAddress)
        ...
        <div className="w-full max-w-md">
          ...
          {!isSignedIn ? (
            ...
            <div className="text-center">
              ...
              <p className="mb-6">Welcome! You can now proceed with your payment.</p>
      ...
      <div className="md:w-1/2 flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {pricesRenderList.map((price) => <PriceItem disabled={checkoutDisable} item={price} key={price.priceId} />)}
          </div>
          </div>
        </div>
      </div>
